    ...
    return (
        <div className="space-y-8">
            ...
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 space-y-4">
                <h2 className="text-lg font-semibold text-gray-800 capitalize border-b pb-2">Company & Industry</h2>
                <div className="grid md:grid-cols-2 gap-4">
                    <div className='col-span-2'>
                        ...
                        <FilterSelect
                            ...
                            selectedOption={allCompanies.find(opt => opt.value === formData.company_id)}
                            required
                    ...
                    <div className='col-span-2 grid grid-cols-2 gap-3'>
                        ...
                        <CustomInput type="number" value={formData?.current_openings} label="Available Opening" onChange={(e) => handleInputChange("current_openings", e.target.value)} name="current_openings" className="w-full h-10 border rounded-lg px-4" placeholder={`Enter number of available posts `} required error={errors?.current_openings} />
            ...
            {/* Job Details Section */}
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 space-y-4">
                <h2 className="text-lg font-semibold text-gray-800 capitalize border-b pb-2">Job Details</h2>
                <div className="grid md:grid-cols-3 gap-4">
                    <FilterSelect
                        ...
                        selectedOption={selectJson?.Job_Type_List.find(opt => opt.value === formData.job_type)}
                        required
                    ...
                    <FilterSelect
                        ...
                        onChange={(selected) => handleSelectChange('job_location', selected)}
                        selectedOption={selectJson?.Job_Location_List.find(opt => opt.value === formData.job_location)}
                        required
                    ...
                    <FilterSelect
                        ...
                        selectedOption={selectJson?.Job_Pay_Type_List.find(opt => opt.value === formData.pay_type)}
                        required
            ...
            {/* Location Section */}
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 space-y-4">
                <h2 className="text-lg font-semibold text-gray-800 capitalize border-b pb-2">Location</h2>
                <div className="grid md:grid-cols-4 gap-4">
                    <FilterSelect2
                        label="Country"
                        selectedOption={countryList?.find(opt => opt.label === getNestedValue(formData, 'address.country.name')) || null}
                    ...
                    <FilterSelect2
                        label="State"
                        selectedOption={stateList?.find(opt => opt.label === getNestedValue(formData, 'address.state.name')) || null}
                    ...
                    <FilterSelect2
                        label="City"
                        selectedOption={citiesList?.find(opt => opt?.label === getNestedValue(formData, 'address.city.name')) || null}
