      ...
      <div className="md:p-4 p-2 ">
        ...
        <div>
          <div className="w-full mx-auto p-6 glassy-card rounded-xl border">
            <div className="mb-8">
              <h1 className="text-[28px] font-bold glassy-text-primary mb-3">
                Project Management
              </h1>
              <p className="text-[#6B6B6B] text-[18px]">
                Learn how to confidently develop custom & profitable Responsive
                WordPress Themes and Websites with no prior experience.
              </p>
            </div>
            ...
            <div className="flex items-center justify-between mb-8 relative">
              ...
              <div className="flex flex-col items-center relative z-10">
                <div className="text-center">
                  <div className="text-base font-medium text-[#6B6B6B]">
                    15 Courses
                  </div>
                </div>
              ...
              <div className="flex flex-col items-center relative z-10">
                ...
                <div className="w-6 h-6 glassy-card rounded-full flex items-center justify-center mb-2"></div>
              </div>
              <div className="flex flex-col items-center relative z-10">
                <div className="text-center">
                  <div className="text-base font-medium text-[#6B6B6B]">
          ...
          <div className="">
            <h2 className="text-2xl font-medium glassy-text-primary py-4">
              Running Activities
            </h2>
            ...
            <div className="glassy-card rounded-lg border border-gray-200  relative">
              <div className="glassy-card p-3 border-b">
                ...
                <div className="mb-4">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <h3 className="text-[20px] font-semibold glassy-text-primary">
                      UI/UX Design for Beginners
                    </h3>
                  </div>
                  <p className="glassy-text-secondary ml-11">
                    Learn how to confidently develop custom & profitable
                    Responsive WordPress Themes and Websites with no prior
                    experience.
                  </p>
                </div>
              ...
              <div className=" bg-[#F9FBFF] pl-12">
                <h4 className="text-sm font-medium glassy-text-primary my-3 uppercase tracking-wide">
                  CHAPTERS:
                </h4>
                <div className="space-y-1">
                  <div className="flex items-center gap-3 p-2  ">
                    ...
                    <span className="font-medium text-[18px] glassy-text-primary">
