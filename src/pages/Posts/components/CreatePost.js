                    ...
                    <form className=' space-y-6' onSubmit={handleSubmit}>
                        ...
                        {(postData.post_type === 'text' || postData?.post_type === 'poll' || postData?.post_type === 'link' || postData?.post_type === 'image-video') && (
                            <div className="space-y-3">
                                ...
                                {renderError('content')}
                                <div className={`text-sm text-right ${getCharacterCountColor(postData.content.length, 1000)}`}>
                            ...
                            <div className="space-y-4">
                                <div className="space-y-3">
                                    ...
                                    <CustomInput
                                        ...
                                        min="1"
                                        max="30"
                                        className={`w-full h-10 ${errors.pollDuration ? 'border-red-500 bg-red-50' : 'border-gray-200 hover:border-gray-300'
                                            }`}
                                        ...
                                        {postData.poll.options.map((option, index) => (
                                            <div key={index} className="flex items-center space-x-2">
                                                <CustomInput
                                                    ...
                                                    className={`flex-1 h-10 ${errors[`pollOption-${index}`] ? 'border-red-500 bg-red-50' : 'border-gray-200 hover:border-gray-300'
                                                        }`}
                                                    value={option}
