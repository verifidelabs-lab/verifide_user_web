...
const CommonSection = ({
  ...
  return (
    <div className="w-full max-w-4xl p-4 mx-auto bg-white border border-gray-200 rounded-lg">
      ...
      {!hasEducationRecords ? (
        <div className="px-6 py-5 text-center border-2 border-gray-300 border-dashed rounded-lg bg-[#FBFBFB]">
