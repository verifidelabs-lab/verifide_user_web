...
const TermsAndConditions = () => {
  ...
  const termsData =
    (apiTermsData?.length > 0 && apiTermsData) || staticTermsData;
  ...
  if (isLoading) {
    return (
      <div className="p-4 md:p-6 flex items-center justify-center min-h-screen glassy-card">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 b order-b-2 border-blue-600 mx-auto mb-4"></div>
          <p className="glassy-text-primary">Loading terms and conditions...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="hidden md:flex space-x-6 items-start   mx-auto">
        ...
        <div className="w-80 glassy-card border border-gray-200 rounded-2xl p-6 shadow-sm sticky top-6">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="text-lg font-bold glassy-text-primary">
              TABLE OF CONTENTS
            </h2>
          </div>
            ...
            {termsData?.tableOfContents?.map((item, index) => {
              ...
              return (
                ...
                <li
                  ...
                  onClick={() => handleSectionClick(item.display_order)}
                  className={`
    block cursor-pointer px-3 py-2 rounded-md transition duration-200

    ${
      isActive
        ? "font-semibold text-blue-500 border-l-4 border-blue-500 bg-[var(--bg-card)]"
        : isPast
        ? "font-medium glassy-text-primary border-l-4 border-[var(--border-color)] bg-[rgba(0,0,0,0.15)]"
        : "font-medium glassy-text-secondary hover:text-blue-500 hover:border-l-4 hover:border-blue-500"
    }
  `}
                >
                  <span className="pr-2">{item.display_order}.</span>{" "}
                  {item.title}
                </li>
              );
            })}
                ...
                >
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <div className="flex-shrink-0">
                      <span className="text-lg font-bold glassy-text-primary">
                        {item.display_order}.
                      </span>
                    </div>
                    ...
                    {/* Title + Content */}
                    <div className="flex-1">
                      <h2 className="text-lg font-semibold glassy-text-primary mb-2">
                        {item.title}
                      </h2>
                      <div
      ...
      <div className="block md:hidden">
        ...
        <nav className="flex items-center space-x-2 mb-4 text-sm">
          ...
          <LuChevronRight className="glassy-text-secondary" size={14} />
          <span className="glassy-text-primary font-semibold">
            Terms & Conditions
          </span>
        </nav>
                ...
                >
                  ...
                  <FaChevronRight
                    className={`transition-transform duration-300 ${
                      isExpanded
                        ? "rotate-90 glassy-text-secondary"
                        : "glassy-text-secondary"
                    }`}
                    size={14}
                  />
