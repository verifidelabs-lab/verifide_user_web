...
const AddEducationModal = ({ formData, collegeList, modalState, handleClose, errors, handleSelectChange, degreeList, fieldsOfStudyList, handleChange,
    skillsList, loading, onClose, onSubmit, setFormData, allSkills, isSkillSelected, handleSkillClick, selectedSkills, setAddModalState, setInputFields,
    isCreatedByUser, isCreatedByUserForFields, isCreatedByUserForIndustry
    ...
    return (
        <div>
            <Modal isOpen={modalState.type === "education"} onClose={handleClose} title={modalState.type}
                handleClose={onClose} handleSubmit={onSubmit} loading={loading}>
                <div className='p-3 space-y-3 '>
                    ...
                    <CustomInput type="checkbox" value={formData?.currently_available} label="Currently Studying"
                        onChange={(e) => {
                            setFormData({
                                ...formData,
                    ...
                    <div>
                        <CustomInput type="textarea" required label="Description" className="w-full" placeholder="Enter description (min length:0 max-length:200)"
