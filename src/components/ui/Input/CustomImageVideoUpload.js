    ...
    <div className={`w-full max-w-4xl mx-auto ${className}`}>
      ...
      {isLoading && (
        <div className="fixed inset-0 glassy-card bg-opacity-50 flex items-center justify-center z-50">
          <div className="glassy-card p-6 rounded-lg flex items-center space-x-3">
            ...
            <span className="glassy-text-primary">Processing files...</span>
          </div>
        </div>
      )}
      ...
      {totalFiles === 0 ? (
        ...
        <div
          ...
          ${isDragging ? 'border-blue-500 glassy-card scale-105' : 'border-gray-300 glassy-card'}`}
        ...
        >
          <div className="flex flex-col items-center justify-center space-y-3">
            <div className="w-14 h-14 glassy-card rounded-full flex items-center justify-center">
              <svg className="w-7 h-7 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path>
              </svg>
            </div>
            <p className="glassy-text-primary font-medium">Drag & drop files here or click to browse</p>
        ...
        <div className="space-y-6">
              ...
              {allMedia.map((media, index) => (
                ...
                >
                  {media.type === 'image' ? (
                    ...
                    <div className="relative w-full h-full glassy-card rounded flex items-center justify-center">
          ...
          {canAddMore() && (
            <button
              type="button"
              onClick={triggerFileInput}
              className="w-full border-2 border-dashed border-gray-300 rounded-lg py-6 px-6 text-center hover:border-blue-400 hover:glassy-card transition-all duration-200 group mt-4"
            >
              <div className="flex flex-col items-center space-y-2">
                <div className="w-10 h-10 glassy-card rounded-full flex items-center justify-center group-hover:bg-blue-200 transition-colors">
