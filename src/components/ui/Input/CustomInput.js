...
const CustomInput = React.forwardRef(({
    ...
    const inputClasses = classNames(
        {
            'opacity-100 rounded-[10px] border border-[#0000001A] bg-white px-4 pr-10 transition-all duration-200 ease-in-out': 
                !isCheckboxOrRadio && (type === 'text' || isPassword || isTextarea),
            'placeholder-[#6B6B6B] focus:border-primary-500 focus:ring-1 focus:ring-primary-500': 
                type !== 'textarea' && !isCheckboxOrRadio && !error,
            'h-4 w-4 text-primary-600 focus:ring-primary-500 border-[#0000001A] bg-white rounded':
                isCheckboxOrRadio,
...
//     const inputClasses = classNames(
//         {
//             'opacity-100 rounded-[10px] border border-[#0000001A] bg-white px-4 transition-all duration-200 ease-in-out': 
