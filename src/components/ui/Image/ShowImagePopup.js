    ...
    <div className="fixed inset-0 glassy-card bg-opacity-50 flex justify-center items-center z-50">
      <div className="glassy-card p-4 rounded-lg max-w-[90vw] max-h-[90vh] overflow-auto relative P-2">
        <div className='flex justify-between'>
          <h2 className='font-semibold glassy-text-primary'>File Name</h2>
          <button
            className="absolute top-2 right-2 glassy-text-primary hover:glassy-text-primary rounded-full p-1 z-10"
            onClick={closePopup}
          >
