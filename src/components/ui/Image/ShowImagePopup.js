...
const ShowImagePopup = ({ imageUrl, isOpen, closePopup }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-4 rounded-lg max-w-[90vw] max-h-[90vh] overflow-auto relative P-2">
        <div className='flex justify-between'>
          <h2 className='font-semibold'>File Name</h2>
          <button
            className="absolute top-2 right-2 text-gray-700 hover:text-[#000000E6] rounded-full p-1 z-10"
            onClick={closePopup}
          >
