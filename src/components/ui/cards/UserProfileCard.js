        ...
        return {
          ...
          description:
            user?.matchedType === "none"
              ? "No match available."
              : `${capitalizeWords(user?.matchedFirstValueName)} and ${
                  user?.matchedCount
                } more ${typeLabels[user?.matchedType] ?? ""} matched.`,
          ...
          stats: {
            first: {
              value: connection || user?.connection_count || 0,
              label: "Connections",
            },
            second: {
              value: follow || user?.follower_count || 0,
              label: "Followers",
            },
            third: {
              value: profile_views || user?.profile_views || 0,
              label: "Views",
            },
          },
      ...
      case "companies":
        ...
        return {
          ...
          stats: {
            ...
            third: {
              value: convertTimestampToYear(user?.founded_year) || "N/A",
              label: "Founded",
            },
          },
