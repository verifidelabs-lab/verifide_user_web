...
const Form = ({ onSubmit, title, children, error, formLayoutClassName = "" }) => {
  return (
    <div className={`flex justify-center h-screen items-center bg-[#FFFFFF]/20    ${formLayoutClassName}`}>
      <div class=" p-[44px_26px] rounded-[10px] border border-[rgba(169, 169, 169, 1)] opacity-100 min-w-  gap-[10px]">
        ...
        <div className="mb-4">
          ...
          <p className='text-[#000000] text-base poppins-regular text-center pt-2'>Learn More. Earn More</p>
        </div>
