...
export const apiUrl = isLive ? 'https://verifide.xyz/api/v1/' : 'http://192.168.1.55:5004/api/v1/';
export const socketApiUrl = isLive ? 'https://verifide.xyz/socket' : 'http://192.168.1.55:5004/socket';
