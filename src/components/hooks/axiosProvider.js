...
export const apiUrl = isLive ? 'https://dev-verifide.verifide.xyz/api/v1/' : 'http://192.168.1.53:5004/api/v1/';
export const socketApiUrl = isLive ? 'https://dev-verifide.verifide.xyz/socket' : 'http://192.168.1.53:5004/socket';
